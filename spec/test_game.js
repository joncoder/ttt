...
describe('games plays until game over', function () {
  ...
  it('should end game when game over', function () {
  	var initial_board = [" ", " ", " ", " ", " ", " ", " ", " ", " "],
        ...
        last_player = final_game_state['last_player'],
        opponent = final_game_state['opponent'];
    ...
    assert.isTrue(helper.count_items_in_array(final_board, last_player['marker']) >= helper.count_items_in_array(final_board, opponent['marker']));
  });
});